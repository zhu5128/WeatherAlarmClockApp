...
public class ZipUtils {
	...
	public static List<File> unzipFileByKeyword(File zipFile, File destDir, String keyword)
		...
		while (entries.hasMoreElements()) {
			...
			if (StringUtils.isEmpty(keyword) || FileUtils.getFileName(entryName).toLowerCase(Locale.US).contains(keyword.toLowerCase(Locale.US))) {
