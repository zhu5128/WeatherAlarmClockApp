 ...
 * <pre>
 * 名称：CrashUtils
 * 作用：Crash捕获与错误日志信息采集类
 * 描述：用于捕获崩溃信息用于调试
 * 作者：pczhu
 * 创建时间： 2017/4/20 下午7:37
 * 版本：V1.0
 * 修改历史：
 * </pre>
 */
public final class CrashUtils
    ...
    public boolean init() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.w("CrashUtils",e.getMessage(),new Throwable(e));
            return false;
        }
    ...
    public void uncaughtException(Thread thread, final Throwable throwable) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                PrintWriter pw = null;
                try {
                    pw = new PrintWriter(new OutputStreamWriter(new FileOutputStream(fullPath),"UTF-8"));
